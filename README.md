...
* 3.2.7+设置页面在: 起点->我的->左上角设置->QD模块设置
...
### 声明
    ...
    已隐藏开源仓库，再大肆宣传就该考虑停更跑路了
    
    因此，我们强烈要求您立即遵守这一指示，以避免任何不利的后果

    近期还发现了倒卖分享内置版、冒充作者等行为，请大家注意甄别，谨防上当受骗
    
    模块永久免费使用，不会以任何形式向用户收取费用
...
* [阅读时长排行榜](https://rank.xihan.website/)，仅是使用模块收集服务的数据，不代表起点官方数据，仅供参考!!!
...
<tr>
<td>
<img src="https://t5.picb.cc/2025/07/18/n991zW.jpg" width=270 >
</td>
<td>
<img src="https://t5.picb.cc/2025/07/18/n99Giw.png" width=270 >
</td>
</tr>
